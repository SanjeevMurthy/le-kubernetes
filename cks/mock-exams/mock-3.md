...
- [Rules](#rules)
- [Tasks](#tasks)
  - [Task 1. kube-bench: fix the kubelet findings (7 points)](#task-1-kube-bench-fix-the-kubelet-findings-7-points)
  - [Task 2. NetworkPolicy: Default-Deny + Selective Allow (6 points)](#task-2-networkpolicy-default-deny--selective-allow-6-points)
  - [Task 3. Remove anonymous access and scope the ServiceAccount (5 points)](#task-3-remove-anonymous-access-and-scope-the-serviceaccount-5-points)
  - [Task 4. The API server is down again: a volume is wrong (7 points)](#task-4-the-api-server-is-down-again-a-volume-is-wrong-7-points)
  - [Task 5. Upgrade kubelet and kubectl on the worker to the latest patch (8 points)](#task-5-upgrade-kubelet-and-kubectl-on-the-worker-to-the-latest-patch-8-points)
  - [Task 6. Host hardening: users, sudo and kernel modules (6 points)](#task-6-host-hardening-users-sudo-and-kernel-modules-6-points)
  - [Task 7. Which pod calls the kill syscall (6 points)](#task-7-which-pod-calls-the-kill-syscall-6-points)
  - [Task 8. AppArmor Profile on a Pod (7 points)](#task-8-apparmor-profile-on-a-pod-7-points)
  - [Task 9. Encryption at rest: add a new key and re-encrypt (8 points)](#task-9-encryption-at-rest-add-a-new-key-and-re-encrypt-8-points)
  - [Task 10. Pod Security: enforce baseline and report violators (5 points)](#task-10-pod-security-enforce-baseline-and-report-violators-5-points)
  - [Task 11. Istio: enforce STRICT mTLS in a namespace (6 points)](#task-11-istio-enforce-strict-mtls-in-a-namespace-6-points)
