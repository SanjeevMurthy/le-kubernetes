...
- [Rules](#rules)
- [Tasks](#tasks)
  - [Task 1. NetworkPolicy: Default-Deny + Selective Allow (6 points)](#task-1-networkpolicy-default-deny--selective-allow-6-points)
  - [Task 2. Ingress TLS Termination (5 points)](#task-2-ingress-tls-termination-5-points)
  - [Task 3. Block the cloud metadata endpoint (5 points)](#task-3-block-the-cloud-metadata-endpoint-5-points)
  - [Task 4. RBAC Least-Privilege Role + Binding (5 points)](#task-4-rbac-least-privilege-role--binding-5-points)
  - [Task 5. The API server is down: find and fix the manifest (7 points)](#task-5-the-api-server-is-down-find-and-fix-the-manifest-7-points)
  - [Task 6. Remove anonymous access and scope the ServiceAccount (5 points)](#task-6-remove-anonymous-access-and-scope-the-serviceaccount-5-points)
  - [Task 7. AppArmor Profile on a Pod (7 points)](#task-7-apparmor-profile-on-a-pod-7-points)
  - [Task 8. seccomp: block mkdir with a Localhost profile (6 points)](#task-8-seccomp-block-mkdir-with-a-localhost-profile-6-points)
  - [Task 9. Enforce Pod Security Admission (restricted) (4 points)](#task-9-enforce-pod-security-admission-restricted-4-points)
  - [Task 10. Encrypt Secrets at Rest (EncryptionConfiguration) (9 points)](#task-10-encrypt-secrets-at-rest-encryptionconfiguration-9-points)
  - [Task 11. Run a Pod under gVisor and capture dmesg (6 points)](#task-11-run-a-pod-under-gvisor-and-capture-dmesg-6-points)
  - [Task 12. Scan Images with Trivy and Remediate (5 points)](#task-12-scan-images-with-trivy-and-remediate-5-points)
  - [Task 13. Static Analysis & Manifest Hardening (kubesec) (5 points)](#task-13-static-analysis--manifest-hardening-kubesec-5-points)
  - [Task 14. Fix two issues in the Dockerfile and two in the manifest (5 points)](#task-14-fix-two-issues-in-the-dockerfile-and-two-in-the-manifest-5-points)
  - [Task 15. Detect Threats with Falco Rules (7 points)](#task-15-detect-threats-with-falco-rules-7-points)
  - [Task 16. Falco: change the output format and save the alerts (8 points)](#task-16-falco-change-the-output-format-and-save-the-alerts-8-points)
