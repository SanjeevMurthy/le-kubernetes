...
- [Rules](#rules)
- [Tasks](#tasks)
  - [Task 1. CIS Benchmark Remediation with kube-bench (8 points)](#task-1-cis-benchmark-remediation-with-kube-bench-8-points)
  - [Task 2. Restrict TLS versions and ciphers (7 points)](#task-2-restrict-tls-versions-and-ciphers-7-points)
  - [Task 3. ServiceAccount Token Hardening (4 points)](#task-3-serviceaccount-token-hardening-4-points)
  - [Task 4. Restrict the API Server (apiserver flags) (7 points)](#task-4-restrict-the-api-server-apiserver-flags-7-points)
  - [Task 5. Issue a client certificate to user jane and bind a Role (6 points)](#task-5-issue-a-client-certificate-to-user-jane-and-bind-a-role-6-points)
  - [Task 6. Seccomp RuntimeDefault + Custom Profile (6 points)](#task-6-seccomp-runtimedefault--custom-profile-6-points)
  - [Task 7. AppArmor: the profile name is not the file name (6 points)](#task-7-apparmor-the-profile-name-is-not-the-file-name-6-points)
  - [Task 8. Host hardening: stop the rogue service and close its port (5 points)](#task-8-host-hardening-stop-the-rogue-service-and-close-its-port-5-points)
  - [Task 9. Admission Policy with Kyverno/Gatekeeper (6 points)](#task-9-admission-policy-with-kyvernogatekeeper-6-points)
  - [Task 10. Runtime Sandbox with RuntimeClass (gVisor) (6 points)](#task-10-runtime-sandbox-with-runtimeclass-gvisor-6-points)
  - [Task 11. Read a Secret straight from etcd (5 points)](#task-11-read-a-secret-straight-from-etcd-5-points)
  - [Task 12. Restrict Images via ImagePolicyWebhook/Registry (9 points)](#task-12-restrict-images-via-imagepolicywebhookregistry-9-points)
  - [Task 13. ImagePolicyWebhook: complete the config and deny unverified images (9 points)](#task-13-imagepolicywebhook-complete-the-config-and-deny-unverified-images-9-points)
  - [Task 14. API Server Audit Logging Policy (8 points)](#task-14-api-server-audit-logging-policy-8-points)
  - [Task 15. Audit log forensics: who deleted the Secret (6 points)](#task-15-audit-log-forensics-who-deleted-the-secret-6-points)
  - [Task 16. Falco: identify the offending pod and stop it (7 points)](#task-16-falco-identify-the-offending-pod-and-stop-it-7-points)
