#!/bin/bash
# Q21 NFS: create the directory to export, start the NFS server, build a peer on
# 10.99.21.0/24 so the export can be proven over the network, and take any export
# or fstab line for this share back out.
