#!/usr/bin/env bash
# Menus for the LFCS practice CLI. Kept bash 3.2 compatible so the list and
# environment views can be inspected outside the lab VM.

show_main_menu() {
  print_header "${ICON_TARGET} LFCS Exam Practice CLI"
...
show_question_list() {
  print_header "${ICON_BOOK} All LFCS Questions"
